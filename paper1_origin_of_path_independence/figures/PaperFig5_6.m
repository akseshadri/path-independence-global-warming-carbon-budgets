% Figs. 5-6: Sensitivity dTs/dm1 and global warming vs cumulative CO2
% Fig 5: (a) Emissions (b) dTs/dm1 (c) |zeta_m1/zeta_r| (d) |zeta_m1/tau_D| (e) r(t) (f) theta
% Fig 6: Global warming vs cumulative CO2 (path independence demonstration)
%
...
for maincount = 1:3
    ...
    plot(s,Ts, char(palc(maincount)), 'LineWidth', 1.0), hold on, ...
        xlabel('year'), ylabel('global warming, T_s  (K)'),...
        xlim([1750 5000])
   ...
   figure(7),
    ...
    subplot(3,2,3), semilogy(m1t1*cfp,abs(taum1./taur),char(pal(maincount)),'LineWidth',1.5),grid on, hold on,...
        xlabel('cumulative CO_2 emissions (PgC)'), ylabel('abs(\varsigma_m_1 / \varsigma_r)'), ylim([0.01 10]), xlim(xlims), 
